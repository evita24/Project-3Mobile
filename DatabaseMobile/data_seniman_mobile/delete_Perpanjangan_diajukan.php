...
$cek_iduser = "SELECT * FROM `perpanjangan` WHERE id_perpanjangan = '$id_perpanjangan'";
...
if ($jumlah_cek == 1) {
    ...
    $get_path_query = "SELECT * FROM perpanjangan WHERE id_perpanjangan = '$id_perpanjangan'";
    ...
    $perintah = "DELETE FROM perpanjangan WHERE `id_perpanjangan` = $id_perpanjangan;";
